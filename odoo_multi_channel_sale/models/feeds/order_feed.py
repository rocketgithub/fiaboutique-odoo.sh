...
# & remove this code
	...
	def import_order(self,channel_id):
		...
		if channel_id.utm_campaign_id:
			vals['campaign_id'] = channel_id.utm_campaign_id.id
		if channel_id.utm_medium_id:
			vals['medium_id'] = channel_id.utm_medium_id.id
		if channel_id.utm_source_id:
			vals['source_id'] = channel_id.utm_source_id.id
